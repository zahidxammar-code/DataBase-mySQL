                   ...
                   <td> 
                      ...
                      <div>
                       <img src="../../assets/img/<?= $key['foto'] ?>" class="avatar avatar-sm me-3" alt="user1">
                          ...
                          <h4 class="text-xs font-weight-bold mb-0"><?= $key['nama']?></h4>
                    ...
                    <td class="align-middle text-center text-sm">
                      <span class="badge badge-sm bg-gradient-success"><?= $key['kelas'] ?></span>
                    </td>
                    <td class="align-middle text-center">
                      <span class="text-secondary text-xs font-weight-bold"><?= $key['jurusan'] ?></span>
                    </td>
                    <td class="align-middle text-center">
                    ...
                    <td class="align-middle">
                      <a href="edit_siswa.php?id=<?= $key['id_siswa'] ?>"
                    ...
                    <td class="align-middle">
                      <a href="#"
                        ...
                        onclick="hapusSiswa(<?= $key['id_siswa'] ?>)"
                        data-toggle="tooltip"
                        data-original-title="Edit user">
                        <i class="fa-solid fa-trash fs-"></i>|delete
                      </a>
                    </td>
                    <!-- <a href="tambah_siswa.php"   class="btn btn-primary btn-lg">TAMBAH SISWA</a> -->
                </tr>
