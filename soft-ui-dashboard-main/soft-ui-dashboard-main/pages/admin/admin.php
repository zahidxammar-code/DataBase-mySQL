                     ...
                     <td> 
                      ...
                      <div>
                       <img src="../../assets/img/<?= $key['foto'] ?>" class="avatar avatar-sm me-3" alt="user1">
                          ...
                          <h4 class="text-xs font-weight-bold mb-0"><?= $key['username']?></h4>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success"><?= $key['password']?></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?= $key['nama']?></span>
                      </td>
                       <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?= $key['alamat']?></span>
                      </td>
                     <td class="align-middle">
                        <a href="edit_admin.php?id=<?= $key['id_admin'] ?>"
                       ...
                       <a href="#"
                        ...
                        onclick="hapusAdmin(<?= $key['id_admin'] ?>)"
                        data-toggle="tooltip"
  ...
  function hapusAdmin(id_admin) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = 'delete_admin.php?id=' + id_admin;
